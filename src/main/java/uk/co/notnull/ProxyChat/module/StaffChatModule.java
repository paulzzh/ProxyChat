...
import uk.co.notnull.ProxyChat.command.StaffChatCommand;
import uk.co.notnull.ProxyChat.listener.StaffChatListener;
...
public class StaffChatModule extends Module {
  ...
  public void onEnable() {
    ...
    ProxyChat.getInstance().getProxy()
        .getEventManager()
        .register(ProxyChat.getInstance(), staffChatListener);
  }

  @Override
  public void onDisable() {
    staffChatCommand.unregister();
    ProxyChat.getInstance().getProxy().getEventManager().unregisterListener(ProxyChat.getInstance(), staffChatListener);
  }
}
