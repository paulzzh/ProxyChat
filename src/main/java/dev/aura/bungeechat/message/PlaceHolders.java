...
public class PlaceHolders {
  ...
  public static void registerPlaceHolders() {
    ...
    PlaceHolderManager.registerPlaceholder(
        new PlaceHolder("%date%", context -> TimeUtil.getDate()));
    ...
    PlaceHolderManager.registerPlaceholder(
        new PlaceHolder("%year%", context -> TimeUtil.getYear()));
