...
public class MuteCommandTest extends AccountManagerTest {
  private static final MuteCommand handler =
      Mockito.mock(MuteCommand.class, Mockito.CALLS_REAL_METHODS);
